var Tfigura = 75; //Tamaño de la figura
...
function(){
for(i = 0; i < (c * r); i++)
$( ".juego" ).append(CrearFigura("cuadrilatero", Tfigura)); 
$( ".juego" ).fadeIn(200);
...
alert("Has acertado la secuencia pasas al Siguiente nivel");
...
window.setTimeout(OcultarfigurasGrises,1200)
}
function OcultarfigurasGrises(){
